    ...
    <section class="showcase">
      <div class="container">
        <div class="pb-2 mt-4 mb-2 border-bottom">
          <h2>Freddie Fantastic From Planet Funk</h2>
        </div>
      ...
      <div class="card-body">
          ...
          <p class="card-text float-right">
            <button type="submit" class="btn btn-sm btn-outline-secondary update-event" data-ueventid="<?php print $element['id'];?>">Edit</button>
            <button type="submit" class="btn btn-sm btn-outline-secondary delete-event" data-deventid="<?php print $element['id'];?>">Delete</button>
          </p>
...
<script src="assets/tinymce/custom.tinymce8.js"></script>